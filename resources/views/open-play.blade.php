...
<script>
(() => {
    const initial = { screen:'home', setup:{ name:'', eventDate:'', eventEndDate:'', courts:2, mode:'balanced', teamCount:null, teamSize:4, teamNames:[], teamColors:[], gamesPerPlayer:4, points:11, pointsOn:true, timer:false }, players:[], rating:0, current:null, history:[], keepHistory:true };
